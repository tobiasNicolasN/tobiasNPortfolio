...
function About() {
  ...
  return (
    <Element name='about'>
      ...
      <h2 className="text-sm md:text-base lg:text-lg xl:text-xl tracking-tracking-wider mt-2 text-gray-600 dark:text-gray-300 animate-fade-right animate-once animate-duration-[400ms] animate-delay-100 animate-ease-in">
        &quot;
        {lang
