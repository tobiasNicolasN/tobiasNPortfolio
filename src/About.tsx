  ...
  return (
    <Element name='about'>
      <div className="animate-fade-right animate-once animate-duration-[400ms] animate-delay-100 animate-ease-in">
        <h1 className="text-base md:text-lg lg:text-xl xl:text-2xl font-sans text-second-light dark:text-second hover:text-offset-second-light dark:hover:text-offset-second duration-300 font-medium inline">
          {lang
