...
function About() {
  ...
  return (
    <Element name="about">
      ...
      <h2 className="text-xs md:text-sm lg:text-base xl:text-lg tracking-wider mt-4 text-gray-800 dark:text-gray-200 animate-fade-right animate-once animate-duration-[400ms] animate-delay-100 animate-ease-in ">
        {lang
      ...
      >
        ...
        <h2 className="text-xs md:text-sm lg:text-base xl:text-lg tracking-tracking-wider mt-4 mb-2 text-gray-600 dark:text-gray-300 animate-fade-right animate-once animate-duration-[400ms] animate-delay-100 animate-ease-in">
          &quot;
          {lang
      ...
      <div className="flex justify-center items-center mt-4 text-center animate-fade-right animate-once animate-duration-[400ms] animate-delay-100 animate-ease-in hover:text-second-light dark:hover:text-second">
        <button
          className={
            !showMoreInfo
              ? 'flex p-2 rounded-lg justify-center shadow-lg items-center text-xs md:text-xs lg:text-sm xl:text-base tracking-wider mt-4 text-gray-800 bg-button-light dark:bg-button hover:ring-2 hover:ring-second-light dark:hover:ring-second dark:text-gray-200 duration-300'
              : 'flex p-2 rounded-lg justify-center items-center text-xs md:text-xs lg:text-sm xl:text-base tracking-wider mt-4 text-transparent bg-transparent dark:bg-transparent hover:ring-2 hover:ring-transparent dark:hover:ring-transparent dark:text-transparent duration-300 select-none'
          }
