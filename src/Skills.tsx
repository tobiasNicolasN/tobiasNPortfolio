    ...
    >
      ...
      <div className="flex md:flex-wrap flex-col mt-4">
        <div className="flex gap-3 md:gap-4 mb-4 md:mb-4 text-xs md:text-sm">
          <button
            className={`duration-300 bg-button-light dark:bg-button hover:bg-offset-button-light dark:hover:bg-offset-button hover:ring-2  hover:ring-second-light dark:hover:ring-second rounded-lg md:p-2 inline-flex items-center justify-center py-2 w-[72px] md:w-24 ${
        ...
        >
          {skills[skill].map((data, index) => (
            <div
              ...
              key={index}
              className={`flex flex-col gap-2 md:gap-3 rounded-lg items-center justify-center bg-button-light dark:bg-button bg-opacity-50 w-[72px] h-20 md:w-24 md:h-28 cursor-pointer lg:hover:ring-2 ring-second-light dark:ring-second duration-300 ${
