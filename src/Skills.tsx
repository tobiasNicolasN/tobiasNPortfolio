    ...
    >
      ...
      <div className="flex md:flex-wrap flex-col mt-4 md:mt-8">
        <div className="flex gap-3 md:gap-6 mb-4 md:mb-6 text-xs">
          <button
            className={`duration-300 bg-button hover:bg-offset-button hover:ring-2  hover:ring-second rounded-lg  md:px-3 md:py-3 md:p-2 inline-flex items-center justify-center py-2 w-16 md:w-32 ${
        ...
        >
          {skills[skill].map((data, index) => (
            <div
              key={index}
              className="flex flex-col gap-2 rounded-lg items-center justify-center bg-button bg-opacity-50 w-16 h-20 md:w-32 md:h-32 hover:bg-opacity-100 hover:scale-105 duration-300"
            >
