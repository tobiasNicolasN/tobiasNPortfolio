    ...
    >
      ...
      <ol className="border-s mt-30 mt-4 border-gray-200 dark:border-gray-700">
        <li className="mb-10 ms-4">
          ...
          <time className="text-[10px] md:text-sm lg:text-sm xl:text-base tracking-tracking-wider mt-4 mb-2 text-gray-600 dark:text-gray-300">
          ...
          <p className="mb-4 text-sm md:text-sm lg:text-base xl:text-lg tracking-tracking-wider text-gray-600 dark:text-gray-300">
            {lang
        ...
        <li className="mb-10 ms-4">
          ...
          <p className="text-sm md:text-sm lg:text-base xl:text-lg tracking-tracking-wider text-gray-600 dark:text-gray-300">
            {lang
