  ...
  return (
    ...
    >
      {projects.map((data, index) => (
        <div
          key={index}
          className="flex flex-col rounded-lg items-center shadow-lg bg-button-light dark:bg-button dark:bg-opacity-50 w-full duration-300"
        >
          <div className="w-full p-4 flex flex-col font-mono gap-2 text-left">
            ...
            <h1 className="text-base md:text-lg xl:text-xl text-gray-800 font-medium dark:text-gray-200 tracking-wider">
              {data.name}
            </h1>
