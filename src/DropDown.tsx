...
function DropDown() {
  ...
  return (
    ...
    >
      <button
        className="z-50 duration-200 bg-button-light dark:bg-button hover:ring-2 hover:ring-second-light dark:hover:ring-second rounded-lg min-w-28 px-3 p-2 inline-flex items-center justify-center group"
        id="myButton"
      >
        ...
        {lang ? 'ES' : 'EN'}
        <span className="group-hover:text-second-light dark:group-hover:text-second duration-200">
          <svg
