...
function Footer() {
  return (
    <footer className="flex flex-col font-sans text-gray-800 dark:text-gray-200 text-sm md:text-base lg:text-lg items-center relative bottom-0">
      <hr className="border-gray-800 dark:border-gray-200 w-full h-1" />
    <div className='items-center w-11/12 md:w-10/12 lg:w-10/12'>
