  ...
  return (
    <div>
      ...
      <div className="w-full flex flex-col items-center mt-40">
        <main className="flex w-full md:w-8/12 flex-col justify-center font-sans">
          <div className="animate-fade-right animate-once animate-duration-[400ms] animate-delay-100 animate-ease-in">
            <Link
              href="/about"
              className="text-xl md:text-2xl font-sans text-second hover:text-offset-second duration-300 font-medium inline"
            >
              {lang
          ...
          <h1 className="text-3xl md:text-5xl mt-4 font-semibold font-mono text-gray-200 animate-fade-right animate-once animate-duration-[400ms] animate-delay-100 animate-ease-in">
            {lang
              ? 'Soy desarrollador FullStack,'
              : "I'm a FullStack developer,"}
          </h1>
          <h1 className="text-base md:text-xl tracking-wider mt-8 text-gray-200 animate-fade-right animate-once animate-duration-[400ms] animate-delay-100 animate-ease-in ">
            {lang
