    ...
    <div>
      ...
      <div className="w-full flex flex-col items-center mt-40">
        <main className="flex w-8/12 flex-col justify-center font-sans">
          ...
          <h1 className="text-5xl mt-4 font-semibold font-mono text-gray-200 animate-fade-right animate-once animate-duration-[400ms] animate-delay-100 animate-ease-in">
            {lang
              ? 'Soy desarrollador FullStack,'
              : "I'm a FullStack developer,"}
          </h1>
          <h1 className="text-xl tracking-wider mt-8 text-gray-200 animate-fade-right animate-once animate-duration-[400ms] animate-delay-100 animate-ease-in ">
            {lang
          ...
          <h1 className="text-xl tracking-tracking-wider mt-8 text-gray-300 animate-fade-right animate-once animate-duration-[400ms] animate-delay-100 animate-ease-in">
            "
            {lang
